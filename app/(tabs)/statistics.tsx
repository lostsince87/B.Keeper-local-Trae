...
export default function StatisticsScreen() {
  ...
  // Calculate honey harvest for current year (January-December)
  ...
  // Calculate varroa trend for current year (January-December)
  const calculateVarroaTrend = () => {
    ...
    for (let i = 0; i < 12; i++) {
      ...
      const monthInspections = inspections.filter(inspection => {
        ...
        return inspectionKey === monthKey && inspection.varroaPerDay !== null && inspection.varroaPerDay !== undefined;
      });
      
      const avgVarroa = monthInspections.length > 0 
        ? monthInspections.reduce((sum, inspection) => sum + (inspection.varroaPerDay || 0), 0) / monthInspections.length
        : 0;
  ...
  // Beräkna avläggare per månad för nuvarande år (januari-december)
      ...
      >
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.chartContainer}>
            <Text style={styles.chartTitle}>Honungsskörd  {new Date().getFullYear()} (kg)</Text>
          ...
          <View style={styles.chartContainer}>
            <Text style={styles.chartTitle}>
              Varroa (per dag) {new Date().getFullYear()}
            </Text>
            <View style={styles.chart}>
          ...
          <View style={styles.chartContainer}>
            <Text style={styles.chartTitle}>Avläggare {new Date().getFullYear()}</Text>
            <View style={styles.chart}>
